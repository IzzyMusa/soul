        ...
        return (
            <View style={{ flex: 2, justifyContent: 'space-between', backgroundColor: 'black'}}>
                ...
                <View style={{ flex: 9, backgroundColor: 'white' }}>
                    ...
                    <View style={{ flex: 1, alignItems: 'center'}}>
                        <Text style={[styles.bigBlue, styles.red]}>{this.state.latitude}, lat</Text>
                        <Text style={[styles.red, styles.bigBlue]}>{this.state.longitude}, long </Text>
                        <Text style={[styles.red, styles.bigBlue]}>{this.state.timestamp}, time</Text>
                    </View>
                    <View style={{ flex: 1, alignItems: 'center'}}>
                        <TextInput
                            style={{ height: 40 }}
